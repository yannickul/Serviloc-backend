...
public class LitigeRepositoryAdapter implements LitigeRepository {
    ...
    @Override
    public long countByStatus(com.serviloc.litiges.domain.model.LitigeStatus status) {
        return litigeJpaRepository.countByStatus(status);
    }

    @Override
    public long countByStatusAndUpdatedAtAfter(com.serviloc.litiges.domain.model.LitigeStatus status,
                                                java.time.Instant since) {
        return litigeJpaRepository.countByStatusAndUpdatedAtAfter(status, since);
    }

    @Override
    public java.math.BigDecimal sumAmountByStatusIn(List<com.serviloc.litiges.domain.model.LitigeStatus> statuses) {
        return litigeJpaRepository.sumAmountByStatusIn(statuses);
    }
