...
public class ProviderDemandController {
    ...
    public ResponseEntity<ApiResponse<ApplyDemandResponse>> applyToDemand(
            @PathVariable String id,
            @RequestHeader("X-User-Id") String providerId) {

        ApplyDemandResponse response = demandUseCase.applyToDemand(id, providerId);
    ...
    public ResponseEntity<ApiResponse<QuoteResponse>> getQuote(
        ...
        return ResponseEntity.ok(
                ApiResponse.success(demandUseCase.getQuoteForDemandAndProvider(id, providerId)));
    }
