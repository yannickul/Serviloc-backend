...
public class RabbitMQConfig {
    ...
    // RK_QUOTE_ACCEPTED supprimé : "negotiation.quote.accepted" est désormais émis par
    // service-negociations lui-même (cf. flux multi-devis), plus par service-mission.
